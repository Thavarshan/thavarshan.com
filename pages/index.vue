...
<template>
  <div class="mt-4 md:mt-10">
    <div class="space-y-4 max-w-xl text-center md:text-left mx-auto md:mx-0">
      ...
      <p class="text-gray-600 text-lg">
        I maintain open-source projects like <a target="_blank" href="https://fetch-php.thavarshan.com" class="text-gray-800 underline">Fetch PHP</a>, <a target="_blank" href="https://github.com/Thavarshan/phpvm" class="text-gray-800 underline">phpvm</a>, <a target="_blank" href="https://github.com/Thavarshan/filterable" class="text-gray-800 underline">Laravel Filterable</a>, <a target="_blank" href="https://github.com/Thavarshan/matrix" class="text-gray-800 underline">Matrix</a>, and <a target="_blank" href="https://altus4.thavarshan.com" class="text-gray-800 underline">Altus 4</a>. My work is rooted in solid design patterns, TDD, and developer experience. If you're interested in Honeymelon — or want to collaborate — feel free to reach out.
      </p>
    </div>
  </div>
</template>
