                ...
                <div class="flex flex-col lg:flex-row justify-center">
                    ...
                    <div class="max-w-sm md:max-w-md lg:max-w-lg">
                        <div class="leading-relaxed text-center lg:text-left">
                            ...
                            <p class="text-gray-700 text-lg mt-4">
                                I love PHP and been using it for a while now, so currently I'm trying to expand my knowledge about Python and JavaScript and at the same time, try to complete as many personal projects as I can. Take a look down below to see what I'm up to on <a href="https://github.com/Thavarshan">GitHub</a> an <a href="https://bitbucket.org/thavarshan/">BitBucket</a>.
                            </p>
