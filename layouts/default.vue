...
<template>
  <a href="https://altus4.thavarshan.com/" target="_blank" class="block">
    <Banner />
  </a>
    ...
    <div class="flex flex-col md:flex-row items-start justify-center gap-x-0 md:gap-x-12 w-full md:max-w-5xl mx-auto">
      <div class="flex flex-col mx-auto md:mx-0 items-center flex-shrink-0">
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger>
              <Avatar class="size-24 hover:shadow border">
            ...
            <Tooltip>
              <TooltipTrigger>
                <Button variant="outline" as-child>
                  <a href="https://github.com/Thavarshan" target="_blank">
                    <Github class="size-6" />
                  </a>
                </Button>
              </TooltipTrigger>
              <TooltipContent side="top">
                github.com/Thavarshan
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger>
                <Button variant="outline" as-child>
                  <a href="https://www.linkedin.com/in/thavarshan" target="_blank">
                    <Linkedin class="size-6" />
                  </a>
                </Button>
              </TooltipTrigger>
              <TooltipContent side="top">
                linkedin.com/Thavarshan
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
      ...
      <div class="w-full flex flex-col mt-4 md:mt-0">
        <div>
          ...
          <div class="flex items-center justify-center md:justify-start gap-x-0 md:gap-x-10 mt-4 divide-x divide-gray-100 border-y border-gray-100 md:border-0">
            ...
            <a href="https://github.com/Thavarshan/thavarshan.com/blob/227f52cd4191800c9da1d1bc2b73421e079c409e/assets/docs/Jerome-Resume.pdf?raw=true" target="_blank" class="p-2 md:p-0 bg-white  hover:bg-gray-100 md:hover:bg-white text-gray-500 hover:text-gray-800 uppercase text-xs font-medium tracking-widest" download>Résumé</a>
          </div>
        </div>
